...
public class TrackedUsersActivity extends ListActivity implements OnClickListener {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Helper.dialogMessage(this, TrackedUsersActivity.this.getString(R.string.do_you_want_to_stop_tracking_this_user, user),
